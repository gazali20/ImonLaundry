<x-layout.default>
    <div class="flex justify-between px-3 ">
        ...
        <a href="/services/create" class="btn bg-purple-600 hover:bg-purple-700 text-white">Tambah Layanan</a>
    </div>
    ...
    <script>
        ...
        <div class="flex justify-between items-center mb-4 w-full">
            <h5 class="font-bold text-lg dark:text-white-light">List Layanan</h5>

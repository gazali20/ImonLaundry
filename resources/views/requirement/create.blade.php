<x-layout.default>
    ...
    <div class="mt-3" x-data="requirementForm">
        <div class="panel">
            ...
            <form @submit.prevent="submitForm()">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 pt-3  items-start">
                    <!-- KIRI: FORM INPUT -->
                    ...
                    <div class="relative w-64 h-64 border bg-gray-100 border-gray-300 rounded-xl overflow-hidden">
                        ...
                        <template x-if="!imagePreview">
                            <label
                                ...
                                <svg width="200" height="200" viewBox="0 0 178 178" fill="none" xmlns="http://www.w3.org/2000/svg">

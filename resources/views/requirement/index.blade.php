<x-layout.default>
    <div class="flex justify-between px-3 ">
        <h1 class=" text-lg font-semibold">Kebutuhan</h1>
        <a href="/requirement/create" class="btn bg-purple-600 hover:bg-purple-700 text-white">Tambah Kebutuhan</a>
    </div>
    ...
    <script>
        document.addEventListener("alpine:init", () => {
            Alpine.data("striped", () => ({
                ...
                init() {
                    ...
                    const requirementsEditUrl =
                        "{{ route('requirement.edit', ['requirement' => ':id']) }}";
                    const tableOptions = {
                        data: {
                            headings: ["ID", "Jenis kebutuhan", "Stock", "Kategori", "Harga/item",
                                "Harga total",
                                "Detail"
                            ],
                            data: this.requirements.map((requirement, index) => {
                                const editRequirement = requirementsEditUrl.replace(':id',
                                    requirement
                                    .id);
                                return [
                                    index + 1,
                         ...
                         <a href="/requirement/${requirement.id}/detail">
        ...
        <div class="flex justify-between items-center mb-4 w-full">
            <h5 class="font-bold text-lg dark:text-white-light">List Kebutuhan</h5>

<x-layout.default>
    <h5 class="font-semibold text-lg dark:text-white-light">Kebutuhan</h5>
    <div x-data="striped" class="panel mt-4">
                                ...
                                return [
                                    ...
                                    `<div>
                                        <a href="/requirement/${requirement.id}/detail">
                                            <div class="hover:bg-purple-200 p-2 rounded-md inline-block">

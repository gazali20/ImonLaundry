            ...
            <form @submit.prevent="submitForm()" method="POST" action="{{ route('vehicle.store') }}" x-ref="form">
                ...
                <div class="gap-5">
                    <div :class="[isSubmitForm ? (form.customer ? 'has-success' : 'has-error') : '']">
                        ...
                        <select id="customCustomer" class="form-select text-white-dark" x-model="form.customer" name="customer_id">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 pt-5">
                        <div :class="[isSubmitForm ? (form.plat ? 'has-success' : 'has-error') : '']">
                            ...
                            <input id="customPlat" type="text" placeholder="Nomor Plat" class="form-input" x-model="form.plat" name="plat" />
                        ...
                        <div :class="[isSubmitForm ? (form.brand ? 'has-success' : 'has-error') : '']">
                            ...
                            <input id="customBrand" type="text" placeholder="Merek" class="form-input" x-model="form.brand" name="brand" />
                    ...
                    <div class="pt-5" :class="[isSubmitForm ? (form.year ? 'has-success' : 'has-error') : '']">
                        ...
                        <input id="customYear" type="number" placeholder="Tahun" class="form-input" x-model="form.year" name="year" />

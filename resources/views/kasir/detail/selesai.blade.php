            ...
            @foreach ($selesai as $kasir)
                @foreach ($kasir->kasirService as $item)
                    <tr>
                        ...
                        <td class="p-3"><a href=""><div class="p-2 hover:bg-purple-200 rounded-md inline-block" ><svg   width="20" height="23" viewBox="0 0 27 30" fill="none" xmlns="http://www.w3.org/2000/svg">

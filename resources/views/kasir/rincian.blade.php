<x-layout.default>
    ...
    <x-layout.default>
        ...
        <div class="flex justify-between items-center w-full">
            ...
            <div class="flex">
                <a href="/kasir" class="btn mr-3 bg-white font-semibold hover:bg-purple-500 hover:text-white text-black shadow-none">Kasir</a>
                ...
                <div class="panel h-36 bg-cover bg-center bg-no-repeat flex flex-col justify-end p-4"
                    ...
                    <div class="flex justify-end">
                        <a href="#" @click="activeTab = 'dicuci'" class="btn border-none"
                            :class="activeTab === 'dicuci' ? 'bg-purple-600 hover:bg-purple-700 text-white' : 'bg-white font-semibold hover:bg-purple-500 hover:text-white text-black'">
                            Sedang Dicuci
                        </a>
                    </div>
                </div>
                ...
                <div class="panel h-36 bg-cover bg-center bg-no-repeat flex flex-col justify-end p-4"
                    ...
                    <div class="flex justify-end">
                        <a href="#" @click="activeTab = 'siap'" class="btn border-none"
                            :class="activeTab === 'siap' ? 'bg-purple-600 hover:bg-purple-700 text-white' : 'bg-white font-semibold hover:bg-purple-500 hover:text-white text-black'">
                            Siap Diambil
                        </a>
                    </div>
                </div>
                ...
                <div class="panel h-36 bg-cover bg-center bg-no-repeat flex flex-col justify-end p-4"
                    ...
                    <div class="flex justify-end">
                        <a href="#" @click="activeTab = 'selesai'" class="btn border-none"
                            :class="activeTab === 'selesai' ? 'bg-purple-600 hover:bg-purple-700 text-white' : 'bg-white font-semibold hover:bg-purple-500 hover:text-white text-black'">
                            Selesai
                        </a>
                    </div>
                </div>
